  ...
  return (
    <Section>
      <Container>
        ...
        <div 
          className="mt-28 flex items-center gap-10 ease-in-out h-[50vh]">
          <Photo/>
          <p 
            className="font-bold text-gray-200 flex flex-col text-left w-[650px]">
        ...
        <footer
          className="mt-28 flex flex-1 flex-row gap-4 bottom-10 fixed"
        >
          <a
          ...
          <a
            className="p-1 bg-gradient-to-r from-yellow-400 to-pink-600 w-[290px] rounded-md cursor-pointer flex"
          >
